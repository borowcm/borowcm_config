...
; 		(throw 'done t))
	    ...
	    ;; the lines added below search for "../src/" directory
	    ;; for an associated file
	    (progn
	      (find-file
	       (concat "../src/" buffer-pre-extension (car new-extension-list)))
	      (throw 'done t))
	    ;; the lines added below search for "../incl/" directory
	    ;; for an associated file
	    (progn
	      (find-file
	       (concat "../incl/" buffer-pre-extension (car new-extension-list)))
	      (throw 'done t))
	    )
	  (setq new-extension-list (cdr new-extension-list)))
